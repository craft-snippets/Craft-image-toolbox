...
class ImageToolboxVariable
{
    ...
    public function svgFile(string $filePath, array $attributes, array $options = []): ?\Twig\Markup
    {
        return ImageToolbox::getInstance()->imageToolbox->svgFile($filePath, $attributes, $options);
    }
